...
var Number = function (_React$Component) {
	...
	_createClass(Number, [{
		...
		value: function render() {
			return React.createElement('input', { type: 'text', value: this.state.value, placeholder: this.props.placeholder, onChange: this.onChange.bind(this), className: 'form-control' });
		}
	}]);
...
var Panel = function (_React$Component) {
	...
	_createClass(Panel, [{
		...
		value: function onAddClick(event) {
			var value = this.refs.number1.state.value * 1 + this.refs.number2.state.value * 1;
			this.setState({ value: value });
		}
	}, {
		key: 'onSubtractClick',
		value: function onSubtractClick(event) {
			var value = this.refs.number1.state.value * 1 - this.refs.number2.state.value * 1;
			this.setState({ value: value });
		}
	}, {
		key: 'onDivideClick',
		value: function onDivideClick(event) {
			if (this.refs.number2.state.value != 0) {
				var value = this.refs.number1.state.value / this.refs.number2.state.value;
				this.setState({ value: value });
			} else {
		...
		key: 'onMultiplyClick',
		value: function onMultiplyClick(event) {
			var value = this.refs.number1.state.value * this.refs.number2.state.value;
			this.setState({ value: value });
		}
	}, {
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-offset-2 col-md-8 panel panel-default' },
						React.createElement(
							'div',
							...
							React.createElement(
								...
								React.createElement(
									'div',
									{ className: 'col-md-6' },
									React.createElement(Number, { ref: 'number1', placeholder: 'First number' })
								),
								React.createElement(
									'div',
									{ className: 'col-md-6' },
									React.createElement(Number, { ref: 'number2', placeholder: 'Second number' })
								)
							),
							React.createElement(
								'div',
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'button',
										{ onClick: this.onAddClick.bind(this), className: 'btn btn-primary form-control' },
										'+ Add'
									)
								),
								React.createElement(
									...
									React.createElement(
										'button',
										{ onClick: this.onSubtractClick.bind(this), className: 'btn btn-primary form-control' },
										'- Subtract'
									)
								),
								React.createElement(
									...
									React.createElement(
										'button',
										{ onClick: this.onDivideClick.bind(this), className: 'btn btn-primary form-control' },
										'/ Divide'
									)
								),
								React.createElement(
									...
									React.createElement(
										'button',
										{ onClick: this.onMultiplyClick.bind(this), className: 'btn btn-primary form-control' },
										'* Multiply'
									)
								)
							),
							...
							React.createElement(
								...
								React.createElement(
									'div',
									{ className: 'col-md-9' },
									React.createElement(Result, { placeholder: 'Result', value: this.state.value })
								),
								React.createElement(
									'div',
									{ className: 'col-md-3' },
									React.createElement(
										'button',
										{ className: 'btn btn-danger form-control', onClick: this.onClearClick.bind(this) },
										'Clear'
									)
								)
							)
...
},{"./Number.jsx":168,"./Result.jsx":170,"react":167}],170:[function(require,module,exports){
"use strict";
...
var Result = function (_React$Component) {
	...
	_createClass(Result, [{
		key: "render",
		value: function render() {
			return React.createElement("input", { type: "text", value: this.props.value, placeholder: this.props.placeholder, className: "form-control" });
		}
	}]);
...
ReactDOM.render(React.createElement(Panel, null), document.getElementById('main'));

},{"./components/Panel.jsx":169,"react":167,"react-dom":29}]},{},[171]);
